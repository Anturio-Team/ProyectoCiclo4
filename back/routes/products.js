...
const {getProducts, newProduct, getProductById, updateProduct, deleteProduct, showProducts} = require("../controllers/productsController")
...
// router.route('/publico').get(showProducts) //mostrar informacion de productos limitada
